...
#                    r-self.mean_vector[2]],axis=3)
        ...
        self.conv_1 = self.conv(
            input_image_,
            ksize=[3, 3, input_image_.get_shape()[-1].value, 32],
            is_training=is_training,
            name='conv_1')
        self.conv_2 = self.conv(
            self.conv_1,
            ksize=[3, 3, 32, 32],
            is_training=is_training,
            name='conv_2')
        ...
        self.conv_3 = self.conv(
            self.pool_1,
            ksize=[3, 3, 32, 64],
            is_training=is_training,
            name='conv_3')
        self.conv_4 = self.conv(
            self.conv_3,
            ksize=[3, 3, 64, 64],
            is_training=is_training,
            name='conv_4')
        ...
        self.conv_5 = self.conv(
            self.pool_2,
            ksize=[3, 3, 64, 128],
            is_training=is_training,
            name='conv_5')
        self.conv_6 = self.conv(
            self.conv_5,
            ksize=[3, 3, 128, 128],
            is_training=is_training,
            name='conv_6')
        ...
        self.conv_7 = self.conv(
            self.pool_3,
            ksize=[3, 3, 128, 256],
            is_training=is_training,
            name='conv_7')
        self.conv_8 = self.conv(
            self.conv_7,
            ksize=[3, 3, 256, 256],
            is_training=is_training,
            name='conv_8')
        ...
        self.conv_9 = self.conv(
            self.pool_4,
            ksize=[3, 3, 256, 512],
            is_training=is_training,
            name='conv_9')
        self.conv_10 = self.conv(
            self.conv_9,
            ksize=[3, 3, 512, 512],
            is_training=is_training,
            name='conv_10')
        ...
        self.conv_11 = self.conv(
            self.concat_10_8,
            ksize=[3, 3, self.concat_10_8.get_shape()[-1].value, 256],
            is_training=is_training,
            name='conv_11')
        self.conv_12 = self.conv(
            self.conv_11,
            ksize=[3, 3, 256, 256],
            is_training=is_training,
            name='conv_12')
        ...
        self.conv_13 = self.conv(
            self.concat_12_6,
            ksize=[3, 3, self.concat_12_6.get_shape()[-1].value, 128],
            is_training=is_training,
            name='conv_13')
        self.conv_14 = self.conv(
            self.conv_13,
            ksize=[3, 3, 128, 128],
            is_training=is_training,
            name='conv_14')
        ...
        self.conv_15 = self.conv(
            self.concat_14_4,
            ksize=[3, 3, self.concat_14_4.get_shape()[-1].value, 64],
            is_training=is_training,
            name='conv_15')
        self.conv_16 = self.conv(
            self.conv_15,
            ksize=[3, 3, 64, 64],
            is_training=is_training,
            name='conv_16')
        ...
        self.conv_17 = self.conv(
            self.concat_16_2,
            ksize=[3, 3, self.concat_16_2.get_shape()[-1].value, 32],
            is_training=is_training,
            name='conv_17')
        self.conv_18 = self.conv(
            self.conv_17,
            ksize=[3, 3, 32, 32],
            is_training=is_training,
            name='conv_18')
